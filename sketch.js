...
function preload() {
  ...
  boatMoveImg= loadImage("./assets/images/boatmove.png");
...
function setup() {
  ...
  page= createImg("./assets/images/page1.png");
  ...
  bagsObject= new Materials(bagsGrp, 30, bagImg, 0.07);
  bottleObject= new Materials(bottleGrp, 25, bottleImg, 0.1);
...
function lives(){
  ...
  function missionFail(title) {
    ...
    message= "Power ran out!" + "\n" +"You collected "+score/10+" pieces of plastic."
    } else if (failureType==3){
      message= "Power ran out! The river is still polluted."
    }
